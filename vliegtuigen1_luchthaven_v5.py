...
APP_NAME = "vliegtuigen1_luchthaven_v5"
        ...
        if option_menu:
            return option_menu(
                ...
                styles={
                    ...
                    "icon": {"color": KLEUREN["primary"], "font-size": "18px"},
                    "nav-link": {
                        "color": KLEUREN["dark"],
                        "font-size": "15px",
                        "margin": "4px 0px",
...
def page_vertragingen():
    ...
    # 2. Status per luchthaven: top 10 geordend op hoogste percentage te laat
    ...
    te_laat_top10 = (
        status_counts[status_counts["status_berekend"] == "Te laat"]
        .sort_values("percentage", ascending=False)
        .head(10)["luchthaven_label"]
        .tolist()
    )

    status_data = status_counts[status_counts["luchthaven_label"].isin(te_laat_top10)].copy()
    status_data["luchthaven_label"] = pd.Categorical(
        status_data["luchthaven_label"],
        categories=te_laat_top10,
        ordered=True,
    )
    ...
    fig = px.bar(
        ...
        title="Top 10 luchthavens met hoogste percentage te late vluchten",
