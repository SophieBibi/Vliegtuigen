...
APP_NAME = "vliegtuigen1_luchthaven_v5_2"
...
KLEUREN = {
    "primary": "#8ED8F8",        # lichtblauw voor geselecteerde knoppen en filters
    "primary_dark": "#2A7DA7",
    "primary_soft": "#EAF8FE",
    "secondary": "#8ECDEB",
    "accent": "#F4A261",
...
def load_luchthaven_data(path: str = LUC_DATA_FILE) -> pd.DataFrame:
    ...
    # Hierdoor werkt de app ook als een oudere dataset wordt gebruikt.
    airline_map = {
        "2L": "Helvetic Airways",
        "A3": "Aegean Airlines",
        "AF": "Air France",
